...
6. Open Firefox customization panel and:
   1. Use _Title bar_ option to toggle CSD if is not set by default.
...
Icons might appear black where they should be white on some systems. I have no idea why, but you can adjust them in the `Celestial/colors/light.css` or `Celestial/colors/dark.css` files, look for `--gnome-icons-hack-filter` var and play with css filters.
