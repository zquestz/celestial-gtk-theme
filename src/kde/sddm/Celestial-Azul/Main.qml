...
Item {
    ...
    // Celestial: the greeter has no color scheme configuration, so the
    // palette is baked in at generation time
    Kirigami.Theme.backgroundColor: "#3a3e47"
    Kirigami.Theme.textColor: "#c6cbcf"
    Kirigami.Theme.disabledTextColor: "#878c92"
    Kirigami.Theme.highlightColor: "#3498db"
    Kirigami.Theme.highlightedTextColor: "#ffffff"
    Kirigami.Theme.negativeTextColor: "#fc4138"
