...
**Note:** GTK asset generation requires `inkscape` and `optipng`; the cursor theme requires `rsvg-convert`; the KDE themes require `sassc`, `rsvg-convert`, and ImageMagick.
